		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Send email to reset password</h2>
				</div>
			</div>
            <div class="row justify-content-center">
						...
						<div class="login-wrap p-4 p-md-5">
							...
							<form method="POST" class="sign-in-form" action="{{ route('password.email') }}">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <label class="form-control-placeholder" for="email">youremail@gmail.com</label>
		                    ...
		                    <p class="text-center">Back to log in? <a data-toggle="tab" href="{{route('login')}}">Log in</a></p>
		                </div>
		            </div>
				</div>
			</div>
