...
<head>
  ...
  <title>Login Account Admin</title>
      ...
      <div class="row">
        <div class="col-sm-6 login-section-wrapper">
          ...
          <div class="login-wrapper my-auto">
            ...
            <p class="login-wrapper-footer-text">Don't have an account? <a href="{{ route('admin.register') }}" class="text-reset">Create Account</a></p>
          </div>
        </div>
